...
class PengurusController extends Controller
{
    ...
    public function pengurus_role(Request $request)
    {
        ...
        $apiUrl = 'http://43.156.75.206/api/residence-commite/?page='.$page;
    ...
    public function waiting_approval_warga(Request $request)
    {
        ...
        $apiUrl = 'http://43.156.75.206/api/warga/?is_checker=false&isreject=false&page='.$page;
    ...
    public function approved_warga(Request $request)
    {
        ...
        $apiUrl = 'http://43.156.75.206/api/warga/?is_checker=true&isreject=false&page='.$page;
    ...
    public function list_biaya(Request $request)
    {
        ...
        $apiUrl = 'http://43.156.75.206/api/tagihan/?page='.$page;
    ...
    public function list_konfirmasi(Request $request)
    {
        ...
        $apiUrl = 'http://43.156.75.206/api/tagihan-warga/?page='.$page.'&status=process';
    ...
    public function list_disetujui(Request $request)
    {
        ...
        // $apiUrl = 'http://43.156.75.206/api/tagihan-warga/self-list/?status=paid&page='.$page;
        $apiUrl = 'http://43.156.75.206/api/tagihan-warga/?page='.$page.'&status=paid';
    ...
    public function list_tunggakan(Request $request)
    {
        ...
        //$apiUrl = 'http://43.156.75.206/api/tagihan-warga/self-list/?status=unpaid&end_due_date=' . $today . '&page=' . $page;
        $apiUrl =   'http://43.156.75.206/api/tagihan-warga/?page=1&status=unpaid&end_due_date=2025-03-22';
