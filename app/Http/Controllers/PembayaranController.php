...
class PembayaranController extends Controller
{
    ...
    public function list_tagihan(Request $request)
    {
        ...
        $apiUrl = 'http://43.156.75.206/api/tagihan-warga/self-list/?status=unpaid,process&page='.$page;
    ...
    public function postPembayaran(Request $request)
    {
        ...
        try {
            ...
            $response = $http->patch(
                'http://43.156.75.206/api/tagihan-warga/bayar/' . $request->tagihan_id . '/',
                $data
            );
    ...
    public function postNote(Request $request)
    {
        ...
        try {
            ...
            $response = $http->post('http://43.156.75.206/api/tagihan-note/create-note/');
            $data_response = json_decode($response->body(), true);
            //dd($data_response);
