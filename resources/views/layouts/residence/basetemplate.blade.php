...
<head>
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="{{ secure_url('assets/plugins/images/pewaca.jpeg') }}">
  <title>Pewaca</title>
  ...
  <!-- CSS -->
  <link href="{{ secure_url('assets/bootstrap/dist/css/bootstrap-5.min.css') }}" rel="stylesheet">
...
<body>
  ...
  <script src="{{ secure_url('assets/bootstrap/dist/js/bootstrap-5.min.js') }}"></script>
