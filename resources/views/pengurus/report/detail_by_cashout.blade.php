...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchAndRender() {
        ...
        let apiUrl = `https://admin.pewaca.id/api/report/cashout/?periode=${periodeVal}&email=${encodeURIComponent(pengurusEmail)}`;
    ...
    function loadMoreData(type) {
        ...
        const unitVal = unitInput.value.trim();
        const pengurusEmail = '{{ Session::get("cred.email") }}';
        let apiUrl = `https://admin.pewaca.id/api/report/cashout/?periode=${periodeVal}&page=${currentPage[type]}&email=${encodeURIComponent(pengurusEmail)}`;
        if (unitVal) apiUrl += `&unit_no=${encodeURIComponent(unitVal)}`;
